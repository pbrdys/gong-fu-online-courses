"""
Django settings for gong_fu_courses project.
...
SECRET_KEY = 'django-insecure-_7)1fbf-fq@nwrz$lw6bipgutntfbw1=hhr#u7avf^ipkkrcib'
...
ROOT_URLCONF = 'gong_fu_courses.urls'
...
WSGI_APPLICATION = 'gong_fu_courses.wsgi.application'
