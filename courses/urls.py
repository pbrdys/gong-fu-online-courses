...
urlpatterns = [
    ...
    path('<slug:course_slug>/<slug:lesson_slug>/edit/', views.lesson_edit, name='lesson_edit'),
    path('<slug:course_slug>/delete/<int:lesson_id>/', views.lesson_delete, name='lesson_delete'),
]